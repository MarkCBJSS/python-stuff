# Simple Calculator tutorial by @TokyoEdTech
...
label_result.configure(bg="black", fg="white", width=14)
...
# Row 5
button_equals = tkinter.Button(root, text="=", bg="blue", fg="white", command=lambda: calculate())
button_equals.grid(row=5, column=0)

button_add_to_memory = tkinter.Button(root, text="M+", command=lambda: add_to_memory())
button_add_to_memory.grid(row=5, column=1)

button_add_to_memory = tkinter.Button(root, text="M-", command=lambda: add_to_memory())
button_add_to_memory.grid(row=5, column=2)

button_add_to_memory = tkinter.Button(root, text="MR", command=lambda: add_to_memory())
button_add_to_memory.grid(row=5, column=3)
